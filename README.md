...
<pre class="wp-block-code has-background" style="background-color:#abb8c3"><code>chmod 544 test.sh</code></pre>
...
<pre class="wp-block-code has-background" style="background-color:#abb8c3"><code>./start_shellscript_executeWithinShellscript.sh</code></pre>
</div>
